...
● VMC: NORTH FLEX / DREAM 6 departure in use. Take Off will be 1+1 at 10" spacing with visual rejoin when airborne. Once above 10200 FT / 20NM R249 LSV resume own navigation to the first route waypoint. This one will be exactly the same for all players in the package.
